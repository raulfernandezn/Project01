...
for(i in c(1:1000))
{
  ...
  #PCA
  PCA.CETA<-principal(DFIA[,-c(1,2)],4,rotate="promax",scores=TRUE)
  #Loadings
...
for(i in c(1:1000))
{
  ...
  #PCA
  PCA.CETB<-principal(DFIB[,-c(1,2)],4,rotate="promax",scores=TRUE)
  #Loadings
...
for(i in c(1:1000))
{
  ...
  DFIO <- DFIO[,-vrio]
  #PCA
  PCA.CETO<-principal(DFIO[,-c(1,2)],4,rotate="promax",scores=TRUE)
  #Loadings
